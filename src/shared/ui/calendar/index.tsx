...
type CustomRootProperties = React.HTMLAttributes<HTMLDivElement> & {
...
>;
type ChevronProperties = React.ComponentProps<
...
export const Calendar = ({
  ...
  return (
    <DayPicker
      ...
      components={{
        Root: ({ className, rootRef, ...properties }: CustomRootProperties) => {
          return (
            <div
